...
$(function(){
	...
	// form 밖의 perPageNum 데이터가 바뀌는 처리
	$("#outPerPageNum").change(function(){
		// alert("change perPageNum");
		// perPageNum의 데이터를 바꾼다.
	...
	// 검색 데이터 세팅
	$("#cate_code1").val("${(empty searchVO.cate_code1)?0:searchVO.cate_code1}");
	$("#cate_code2").val("${(empty searchVO.cate_code2)?0:searchVO.cate_code2}");
...
<div class="container">
	...
	<div class="card">
		...
		<!-- start of .card-body -->
		<div class="card-body">
			<div class="mb-2 pb-2" style="border-bottom: 1px solid #ccc">
				<button type="button" class="btn btn-primary"
				 data-toggle="collapse" data-target="#searchForm">상세 검색</button>
				  ...
				  <div class="input-group mb-3">
				    ...
				    <select id="outPerPageNum" class="form-control">
				    	<option>6</option>
				    	<option>9</option>
				    	<option>12</option>
				    	<option>15</option>
			...
			<!-- start of .card-body searchForm -->
			<form action="list.do" id="searchForm" class="collapse">
