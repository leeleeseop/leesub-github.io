	...
	<div class="card">
	  <div class="card-header">
		<div class="media border p-3">
		  <img src="${vo.senderPhoto }" class="mr-3 mt-3 rounded-circle"
		   style="width:60px;">
...
<c:if test="${param.accept!=1}">
	...
	<div class="card">
	  <div class="card-header">
		<div class="media border p-3">
		  <img src="${vo.accepterPhoto }" class="mr-3 mt-3 rounded-circle"
		   style="width:60px;">
		  <div class="media-body">
		    ${vo.accepterName }<small><i>(${vo.accepterId })</i></small>
		    <p>받은 날짜 : ${(empty vo.acceptDate)?"읽지 안음":vo.acceptDate } 
		     / 보낸 날짜 : ${vo.sendDate }</p>
		  </div>
		</div>
	  </div>
