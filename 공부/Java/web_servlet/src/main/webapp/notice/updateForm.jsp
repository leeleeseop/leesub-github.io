...
<div class="container">
	<form action="update.do" method="post">
		...
		<table class="table">
			...
			<tr>
					<th>게시일</th>
					<td><input id="startDate" name="startDate" required autocomplete="off" class="form-control datepicker" value="${vo.startDate }"></td>
				</tr>
				<tr>
					<th>종료일</th>
					<td><input id="endDate" name="endDate" required autocomplete="off" class="form-control datepicker" value="${vo.endDate }"></td>
				</tr>
			<tr>
				<td colspan="2">
