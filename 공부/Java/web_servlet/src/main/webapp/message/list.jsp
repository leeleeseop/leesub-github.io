...
<body>
<div class="container">
	<h3>${(pageObject.acceptMode == 1)?"받은메세지":(pageObject.acceptMode == 2)?"보낸":"모든" }Message List</h3>
	<div>
					...
					<div class="media border p-3 dataRow"
						...
						<c:if test="${vo.senderId == login.id }">
							...
							<div class="media-body text-right ${(empty vo.acceptDate)?'font-weight-bold':'' }">
								...
								<p>번호 : <span class="no">${vo.no }</span> / 보낸 날짜 : ${vo.sendDate } / 읽은 날짜 : ${(empty vo.acceptDate)?"읽지 안음":vo.acceptDate }</p>
							</div>
							<img
								src="${vo.accepterPhoto }"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="form-group">
	      	...
	      	<div class="form-group">
	      		<label>보낼 메시지</label>
	      		<textarea name="content" required rows="5" class="form-control"></textarea>
	      	</div>
      </div>
      <!-- Modal footer -->
