		...
		<table class="table">
			...
			<tr>
				<td colspan="2">
					...
					<!--<input type="hidden" name="no" value="10"> <input name="pw" required maxlength="20"  --> 
					<!--pattern="^.{3,20}$" id="pw" title="3~20자 입력 가능" placeholder="본인 확인용 비밀번호"> -->
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="delete.jsp" method="post" id="deleteForm" class="form-inline">
						<input type="hidden" name="no" value="10"> <input name="pw" required maxlength="20" 
						type="password" pattern="^.{3,20}$" id="pw" title="3~20자 입력 가능" 
						placeholder="본인 확인용 비밀번호" style="padding: 5px">
